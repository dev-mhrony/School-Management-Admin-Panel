                ...
                .on(
                  ...
                  a.proxy(function (b, c) {
                    ...
                    for (l = {}, f = 0, g = k.length; g > f; f++)
                      (-1 !== i.indexOf("down") &&
                        -1 !== a.inArray(k[f], d.children_d)) ||
                        (-1 !== i.indexOf("up") &&
                          -1 !== a.inArray(k[f], d.parents)) ||
                        (l[k[f]] = !0);
                    k = [];
              ...
              if (j && j._data && j._data.dnd)
                if (
                  (g.attr(
                    ...
                    "jstree-" +
                      j.get_theme() +
                      (j.settings.core.themes.responsive
                        ? " jstree-dnd-responsive"
                        : "")
                  ),
                  (C =
                  ...
                  i.helper
                    ...
                    .first()
                    [C ? "show" : "hide"](),
                  (i.event.target !== j.element[0] &&
                    i.event.target !== j.get_container_ul()[0]) ||
                    0 !== j.get_container_ul().children().length)
                ) {
                  if (
                    ((k = j.settings.dnd.large_drop_target
                      ? a(i.event.target)
                          .closest(".jstree-node")
                          .children(".jstree-anchor")
                    ...
                    k &&
                      ...
                      (m =
                        (i.event.pageY !== b
                          ? i.event.pageY
                          : i.event.originalEvent.pageY) - l.top),
                      (q = k.outerHeight()),
                      (t =
                        q / 3 > m
                          ? ["b", "i", "a"]
                      ...
                      a.each(t, function (b, e) {
                        ...
                        for (u = !0, v = 0, w = i.data.nodes.length; w > v; v++)
                          if (
                            ...
                            "move_node" === x &&
                              ...
                              i.data.origin &&
                              i.data.origin === j &&
                              r === j.get_parent(i.data.nodes[v]) &&
                              ((z = j.get_node(r)),
                              y > a.inArray(i.data.nodes[v], z.children) &&
                                (y -= 1)),
                            (u =
                              u &&
                              ((j &&
                                j.settings &&
                                j.settings.dnd &&
                                j.settings.dnd.check_while_dragging === !1) ||
                                j.check(
                                  x,
                                  i.data.origin && i.data.origin !== j
                                    ? i.data.origin.get_node(i.data.nodes[v])
                                    : i.data.nodes[v],
                                  r,
                                  y,
                                  {
                        ...
                        return (
                          "i" === e &&
                            k.parent().is(".jstree-closed") &&
                            j.settings.dnd.open_timeout &&
                            (f = setTimeout(
                              (function (a, b) {
                                return function () {
                                  a.open_node(b);
                  ...
                  if (u)
                    return (
                      (c = { ins: j, par: a.jstree.root, pos: "last" }),
                      g.hide(),
                      i.helper
                        .find(".jstree-icon")
                        .first()
                      ...
                      void (
                        i.event.originalEvent &&
                        i.event.originalEvent.dataTransfer &&
                        (i.event.originalEvent.dataTransfer.dropEffect = C
                          ? "copy"
                          : "move")
                      )
                    );
