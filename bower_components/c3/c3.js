(function (window) {
  ...
  c3.chart = {
    fn: Chart.prototype,
    internal: { fn: ChartInternal.prototype, axis: { fn: Axis.prototype } },
  };
  ...
  c3_chart_internal_fn.initParams = function () {
    ...
    $$.legendItemWidth = 0;
    $$.legendItemHeight = 0;
    $$.currentMaxTickWidths = { x: 0, y: 0, y2: 0 };
  ...
  c3_chart_internal_fn.updateSizes = function () {
    ...
    $$.margin3 = { top: 0, right: NaN, bottom: 0, left: 0 };
  ...
  c3_chart_internal_fn.getInterpolate = function (d) {
    var $$ = this,
      interpolation = $$.isInterpolationType(
