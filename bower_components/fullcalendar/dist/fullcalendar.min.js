!(function (t) {
  ...
  function O(t, e) {
    ...
    for (
      n = 0;
      n < Kt.length && ((i = Kt[n]), (r = V(i, t, e)), !(r >= 1 && pt(r)));
      n++
    );
    return i;
  }
  ...
  function _(t, e) {
    ...
    return J(t) || J(e)
      ...
      : ((n = t.asMonths()),
        (i = e.asMonths()),
        Math.abs(n) >= 1 && pt(n) && Math.abs(i) >= 1 && pt(i)
          ? n / i
          : t.asDays() / e.asDays());
  }
  function Y(t, n) {
  ...
  function wt(t, e) {
    var n;
    return (
      st(e, "constructor") && (n = e.constructor),
      "function" != typeof n &&
        (n = e.constructor =
          function () {
  ...
  function At(t) {
    ...
    if (void 0 === t.forwardPressure) {
      for (e = 0; e < i.length; e++)
        (n = i[e]), At(n), (r = Math.max(r, 1 + n.forwardPressure));
      t.forwardPressure = r;
    }
  }
  function Gt(t, e, n) {
  ...
  function _t(n, i) {
    ...
    function o() {
      ...
      (z = new Vt(e)),
        ...
        F.options.handleWindowResize &&
          ((Y = mt(v, F.options.windowResizeDelay)), t(window).resize(Y));
    }
    function a() {
      P && P.removeElement(),
    ...
    function u(e, n) {
      ...
      i && (H(), c()),
        !P &&
          e &&
          ((P = F.view = U[e] || (U[e] = F.instantiateView(e))),
          P.setElement(
            t("<div class='fc-view fc-" + e + "-view' />").appendTo(O)
          ),
          z.proxyCall("activateButton", e)),
        P &&
          l() &&
          (n && P.captureInitialScroll(n),
    ...
    function g() {
      ...
      _ =
        "number" == typeof t
          ...
          : "parent" === e
          ? n.parent().height() - p()
          : Math.round(O.width() / Math.max(F.options.aspectRatio, 0.5));
    }
    function p() {
    ...
    function v(t) {
      !j &&
        ...
        P.renderRange &&
        h(!0) &&
        P.publiclyTrigger("windowResize", W);
    }
    function m() {
    ...
    function L(t) {
      ...
      if (1 === n) {
        ...
        if ("businessHours" === e)
          return void (
            P && (P.unrenderBusinessHours(), P.renderBusinessHours())
          );
        if ("timezone" === e)
          return F.rezoneArrayEventSources(), void F.refetchEvents();
      }
      b(), E(), (U = {}), d();
    }
    function M(t) {
    ...
    function B(t, e) {
      ...
      if (((e = e || W), this.triggerWith(t, e, n), F.options[t]))
    ...
    F.bindOptions(
      ...
      function (t, e, n, i, s, o, a) {
        ...
        ("ISO" !== a && "local" !== a && "function" != typeof a) ||
          (N._fullCalendar_weekCalc = a),
          F.currentDate && r(F.currentDate);
      }
    ),
      (F.defaultAllDayEventDuration = e.duration(
        F.options.defaultAllDayEventDuration
      )),
      (F.defaultTimedEventDuration = e.duration(
        F.options.defaultTimedEventDuration
      )),
      (F.moment = function () {
        var t;
        return (
          "local" === F.options.timezone
            ? ((t = qt.moment.apply(null, arguments)), t.hasTime() && t.local())
            : (t =
                "UTC" === F.options.timezone
      ...
      (F.getDefaultEventEnd = function (t, e) {
        ...
        return (
          t
            ? n.stripTime().add(F.defaultAllDayEventDuration)
            : n.add(F.defaultTimedEventDuration),
    ...
    this.initCurrentDate(),
      ...
      (F.isHeightAuto = function () {
        return (
          "auto" === F.options.contentHeight || "auto" === F.options.height
        );
      }),
      ...
      (F.updateToolbarButtons = function () {
        ...
        z.proxyCall(
          e.isValid && !q(t, P.currentRange) ? "enableButton" : "disableButton",
          "today"
        ),
  ...
  function Ut() {
    ...
    function r(t) {
      ...
      for (e = 0; e < t.length; e++)
        (n = t[e]),
          n.start.clone().stripZone() < q &&
            U.getEventEnd(n).stripZone() > j &&
            i.push(n);
      return i;
    }
    function s(t, e) {
        ...
        if (n === e._fetchId && "rejected" !== e._status) {
          if (((e._status = "resolved"), i))
            for (r = 0; r < i.length; r++)
              (s = i[r]), (o = a ? s : N(s, e)), o && K.push.apply(K, _(o));
          h();
        }
      });
    }
    ...
    function f(e, n) {
      ...
      for (i = 0; i < s.length; i++) {
        if (
          ((r = s[i].call(U, e, j.clone(), q.clone(), U.options.timezone, n)),
          r === !0)
        )
          return;
    ...
    function N(n, i) {
      ...
      if (
        ...
        n.className
          ? "string" == typeof n.className
            ? (a.className = n.className.split(/\s+/))
        ...
        s && ((s = U.moment(s)), s.isValid() || (s = null)),
          (o = n.allDay),
          void 0 === o &&
            (o = lt(i ? i.allDayDefault : void 0, U.options.allDayDefault)),
          O(r, s, o, a);
      }
    ...
    function Y(e, n, i) {
      ...
      return (
        ...
        { dateDelta: a, durationDelta: u, undo: c }
      );
    }
  ...
  var qt = (t.fullCalendar = { version: "3.3.0", internalApiVersion: 8 }),
    Zt = (qt.views = {});
  ...
  he.mixin({
    ...
    initAutoScroll: function () {
      ...
      (this.isAutoScroll =
        ...
        this.isAutoScroll &&
          this.listenTo(t, "scroll", mt(this.handleDebouncedScroll, 100));
    },
        ...
        return (
          q(t, i.activeRange)
            ? (r.push("fc-" + Xt[t.day()]),
              ...
              t.isSame(n, "day")
                ? (r.push("fc-today"),
                  e !== !0 && r.push(i.highlightStateClass))
                : t < n
                ? r.push("fc-past")
                : r.push("fc-future"))
  ...
  ve.mixin({
          ...
          hitOver: function (n, o, l) {
            ...
            h && f
              ? ((i = e
                ...
                (u = i && r.isEventLocationAllowed(i, c)))
              : (u = !1),
              u
                ? i.start.isSame(c.start.clone().stripZone()) &&
                  ...
                  (i = null)
                : ((i = null), s()),
              i && (a.hideEvent(c), r.renderEventResize(i, t));
          },
          hitOut: function () {
    ...
    computeEventResize: function (t, e, n, i) {
      ...
      return (
        ...
        r.allDay && J(a) && ((r.allDay = !1), o.normalizeEventTimes(r)),
        r[t].add(a),
      ...
      return (
        t.each(r, function (t, e) {
          ...
          for (o = 0; o < e.length; o++)
            (r = i.eventToRange(e[o])), r && (l.push(r), a.push(e[o]));
          if (xt(e[0]))
      ...
      renderDates: function (t) {
        ...
        for (
          this.el.html(o),
            ...
            this.rowCoordCache = new de({ els: this.rowEls, isVertical: !0 }),
  ...
  ye.mixin({
    ...
    getEventSegs: function () {
      return ve.prototype.getEventSegs
        .call(this)
      ...
      limitRow: function (e, n) {
        ...
        if (n && n < w.segLevels.length) {
          for (
            ...
            for (l = r[a], i(l.leftCol), d = [], c = 0; E <= l.rightCol; )
              (u = this.getCellSegs(e, E, n)), d.push(u), (c += u.length), E++;
            if (c) {
              for (
                h = s[n - 1][l.leftCol],
                  f = h.attr("rowspan") || 1,
          ...
          .on("click", function (o) {
            ...
            "function" == typeof a &&
              (a = s.publiclyTrigger(
                "eventLimitClick",
                null,
                { date: l, dayEl: c, moreEl: u, segs: h, hiddenSegs: f },
                o
              )),
              "popover" === a
  ...
  var Se = (qt.TimeGrid = ve.extend(me, {
    ...
    renderDates: function () {
      this.el.html(this.renderHtml()),
        ...
        (this.colCoordCache = new de({ els: this.colEls, isHorizontal: !0 })),
        (this.slatCoordCache = new de({ els: this.slatEls, isVertical: !0 })),
      ...
      for (
        ...
        (t = this.start.clone().time(a)),
          ...
          (i =
            ...
            r.axisStyleAttr() +
            ">" +
            (n ? "<span>" + ut(t.format(this.labelFormat)) + "</span>" : "") +
            "</td>"),
          (o +=
            '<tr data-time="' +
            t.format("HH:mm:ss") +
    ...
    computeLabelInterval: function (t) {
      ...
      for (n = Ae.length - 1; n >= 0; n--)
        if (((i = e.duration(Ae[n])), (r = _(i, t)), pt(r) && r > 1)) return i;
      return e.duration(t);
    },
    computeEventTimeFormat: function () {
        ...
        '<a class="' +
          ...
          (n
            ? '<div class="fc-time" data-start="' +
              ...
              "</span></div>"
            : "") +
          (o.title ? '<div class="fc-title">' + ut(o.title) + "</div>" : "") +
          '</div><div class="fc-bg"/>' +
  ...
  var we = (qt.View = St.extend(le, ue, {
    ...
    executeDateRender: function (t) {
      var e = this,
        n = !1;
      return (
        t && (n = e.setRangeFromDate(t)),
        t && !n && e.isDateRendered
          ? Et.resolve()
    ...
    whenEventsSet: function () {
      ...
      return this.isEventsSet
        ? Et.resolve(this.getCurrentEvents())
        : new Et(function (e) {
            t.one("eventsSet", e);
          });
    },
  ...
  we.mixin({
    ...
    setRangeFromDate: function (t) {
      ...
      return (
        (!this.activeRange || !Q(this.activeRange, e.activeRange)) &&
    ...
    buildRangeInfo: function (t, n) {
      var i,
        ...
        c = null;
      return (
        (i = this.buildCurrentRangeInfo(l, n)),
    ...
    buildRangeFromDuration: function (t, e, n, i) {
      ...
      return (
        n.as("days") <= 1 &&
          this.isHiddenDay(o) &&
          ((o = this.skipHiddenDays(o, e)), o.startOf("day")),
        o.startOf(s || i),
        (r = o.clone().add(n)),
        { start: o, end: r }
      );
    ...
    buildRangeFromDayCount: function (t, e, n) {
      ...
      r && o.startOf(r),
        ...
        (i = o.clone());
      do i.add(1, "day"), this.isHiddenDay(i) || s++;
      while (s < n);
      ...
      for (
        ...
        (i = Zt[h]),
          ...
          i &&
            ...
            (s = s || i.duration),
            (h = h || i.type)),
          r && (d.unshift(r), (s = s || r.duration), (h = h || r.type));
      return (
        (i = nt(u)),
        (i.type = t),
        !!i.class &&
          ...
          s &&
            ...
            o.valueOf() &&
              ...
              (i.duration = o),
              (i.durationUnit = a),
              1 === o.as(a) && ((i.singleUnit = a), d.unshift(l[a] || {})))),
          (i.defaults = n(c)),
          (i.overrides = n(d)),
    ...
    (Ee.prototype.isSpanAllowed = function (t, e, n, i) {
      ...
      for (o = this.getPeerEvents(t, i), a = 0; a < o.length; a++)
        if (((l = o[a]), this.eventIntersectsRange(l, t))) {
          ...
          if (i) {
            if (((u = lt(l.overlap, (l.source || {}).overlap)), u === !1))
              return !1;
  ...
  var ke = (qt.BasicView = we.extend({
    ...
    Me = (qt.MonthView = ke.extend({
      buildRenderRange: function () {
        var t,
          e = ke.prototype.buildRenderRange.apply(this, arguments);
        return (
          this.isFixedWeeks() &&
    ...
    Oe = ve.extend({
      ...
      spanToSegs: function (t) {
        for (
          ...
          if (
            ((e = N(t, { start: i, end: i.clone().add(1, "day") })),
      ...
      renderEmptyMessage: function () {
        this.el.html(
          '<div class="fc-list-empty-wrap2"><div class="fc-list-empty-wrap1"><div class="fc-list-empty">' +
            ut(this.view.opt("noEventsMessage")) +
            "</div></div></div>"
        );
      },
      ...
      fgSegHtml: function (t) {
        ...
        return (
          (e = s.allDay
            ...
            : n.isMultiDayEvent(s)
            ? t.isStart || t.isEnd
              ? ut(this.getEventTimeText(t))
              : n.getAllDayHtml()
            : ut(this.getEventTimeText(s))),
          o && i.push("fc-has-url"),
          '<tr class="' +
            i.join(" ") +
            '">' +
