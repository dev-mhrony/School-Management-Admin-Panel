(function (factory) {
  ...
  Clndr.prototype.render = function () {
    ...
    if (this.options.lengthOfTime.days) {
      ...
      for (i = 0; i < this.options.lengthOfTime.months; i++) {
        ...
        months.push({ days: days, month: currentIntervalStart });
      }
      for (i in months) {
  ...
  Clndr.prototype.buildTargetObject = function (currentTarget, targetWasDay) {
    var target = { date: null, events: [], element: currentTarget };
  ...
  Clndr.prototype.triggerEvents = function (ctx, orig) {
    var timeOpt = ctx.options.lengthOfTime,
      ...
      newInt = { end: ctx.intervalEnd, start: ctx.intervalStart },
  ...
  Clndr.prototype.back = function (options) {
    var yearChanged = null,
      ...
      defaults = { withCallbacks: false },
      orig = { end: ctx.intervalEnd.clone(), start: ctx.intervalStart.clone() };
  ...
  Clndr.prototype.previousYearAction = function (event) {
    var ctx = event.data.context;
    ctx.previousYear({ withCallbacks: true }, ctx);
  };
  ...
  Clndr.prototype.nextYearAction = function (event) {
    var ctx = event.data.context;
    ctx.nextYear({ withCallbacks: true }, ctx);
  };
  ...
  Clndr.prototype.todayAction = function (event) {
    var ctx = event.data.context;
    ctx.today({ withCallbacks: true }, ctx);
  };
