(function (C, p) {
    ...
    if (this._options.steps)
      for (var d = 0, f = this._options.steps.length; d < f; d++) {
        ...
        if ("undefined" === typeof e.element || null == e.element) {
          ...
          null == g &&
            ...
            (g.className = "introjsFloatingElement"),
      ...
      for (e = f.length; d < e; d++)
        if (((g = f[d]), "none" != g.style.display)) {
          var l = parseInt(g.getAttribute("data-step"), 10);
          0 < l &&
            (b[l - 1] = {
              element: g,
      ...
      for (e = f.length; d < e; d++)
        if (((g = f[d]), null == g.getAttribute("data-step"))) {
          ...
          b[l] = {
            ...
            highlightClass: g.getAttribute("data-highlightClass"),
            position:
              g.getAttribute("data-position") || this._options.tooltipPosition,
          };
        }
    }
    d = [];
    ...
    U.call(c, a) &&
      ...
      (c._onKeyDown = function (b) {
        if (27 === b.keyCode && !0 == c._options.exitOnEsc)
          ...
          d && 0 < d.className.indexOf("introjs-prevbutton")
            ? E.call(c)
            : d && 0 < d.className.indexOf("introjs-skipbutton")
      ...
      window.addEventListener
        ? (this._options.keyboardNavigation &&
            window.addEventListener("keydown", c._onKeyDown, !0),
          window.addEventListener("resize", c._onResize, !0))
        : document.attachEvent &&
          (this._options.keyboardNavigation &&
            document.attachEvent("onkeydown", c._onKeyDown),
  ...
  function y(a) {
    ...
    for (c in a)
      b[c] =
        "undefined" != typeof jQuery && a[c] instanceof jQuery ? a[c] : y(a[c]);
    return b;
  }
  function z() {
    ...
    if (this._introItems.length <= this._currentStep)
      ...
      "undefined" !== typeof this._introBeforeChangeCallback &&
        this._introBeforeChangeCallback.call(this, a.element);
      N.call(this, a);
    }
  }
  function E() {
  ...
  function A(a) {
    ...
    (c = a.querySelector(".introjs-helperLayer")) &&
      c.parentNode.removeChild(c);
    (c = a.querySelector(".introjs-tooltipReferenceLayer")) &&
      c.parentNode.removeChild(c);
  ...
  function G(a, b, c, d, f) {
    ...
    "undefined" != typeof d &&
      null != d &&
      ((d.style.top = null), (d.style.left = null));
    if (this._introItems[this._currentStep]) {
      ...
      if (
        ("auto" == l || "auto" == this._options.tooltipPosition) &&
        "floating" != l
      ) {
        e = l;
        ...
        var x = t(b).height + 10,
          ...
          k = t(a),
          m = "floating";
        k.left + q > l.width || 0 > k.left + k.width / 2 - q
          ? (s(g, "bottom"), s(g, "top"))
          : (k.height + k.top + x > l.height && s(g, "bottom"),
            0 > k.top - x && s(g, "top"));
        k.width + k.left + q > l.width && s(g, "right");
        0 > k.left - q && s(g, "left");
        0 < g.length && (m = g[0]);
      ...
      switch (l) {
        ...
        case "right":
          ...
          e.top + a.height > g.height
            ? ((c.className = "introjs-arrow left-bottom"),
              (b.style.top = "-" + (a.height - e.height - 20) + "px"))
        ...
        case "left":
          ...
          e.top + a.height > g.height
            ? ((b.style.top = "-" + (a.height - e.height - 20) + "px"),
              (c.className = "introjs-arrow right-bottom"))
  ...
  function I(a, b, c, d, f) {
    if (a.left + b + c.width > d.width)
      return (f.style.left = d.width - c.width - a.left + "px"), !1;
    f.style.left = b + "px";
    return !0;
  }
  function O(a, b, c, d) {
    if (0 > a.left + a.width - b - c.width)
      return (d.style.left = -a.left + "px"), !1;
    d.style.right = b + "px";
    return !0;
  }
  function s(a, b) {
  ...
  function r(a) {
    if (a && this._introItems[this._currentStep]) {
      var b = this._introItems[this._currentStep],
        ...
        d = 10;
      J(b.element)
        ? (a.className += " introjs-fixedTooltip")
        : (a.className = a.className.replace(" introjs-fixedTooltip", ""));
  ...
  function N(a) {
    ...
    if (null != c) {
      ...
      if (null != e) {
        ...
        if (
          (null != h &&
            ...
            "floating" == h.position) ||
          ("backward" == this._direction && "floating" == a.position)
        )
          e.style.opacity = 0;
      }
      r.call(b, c);
      ...
      if ((h = document.querySelectorAll(".introjs-fixParent")) && 0 < h.length)
        for (f = h.length - 1; 0 <= f; f--)
          h[f].className = h[f].className
            .replace(/introjs-fixParent/g, "")
            .replace(/^\s+|\s+$/g, "");
      if ((h = document.querySelector(".introjs-showElement")))
      ...
      b._lastShowElementTimer = setTimeout(function () {
        ...
        G.call(b, a.element, x, l, e);
        b._options.showBullets &&
          ((d.querySelector(".introjs-bullets li > a.active").className = ""),
          (d.querySelector(
            '.introjs-bullets li > a[data-stepnumber="' + a.step + '"]'
          ).className = "active"));
        d.querySelector(".introjs-progress .introjs-progressbar").setAttribute(
          "style",
          "width:" + P.call(b) + "%;"
        );
        x.style.opacity = 1;
      ...
      p.className = f;
      k.className = "introjs-tooltipReferenceLayer";
      r.call(b, p);
      r.call(b, k);
      ...
      f.setAttribute("style", "width:" + P.call(this) + "%;");
      F.appendChild(f);
      ...
      D(k);
      k.innerHTML = this._options.prevLabel;
      q = document.createElement("a");
      q.className = "introjs-button introjs-skipbutton";
      D(q);
      q.innerHTML = this._options.skipLabel;
      q.onclick = function () {
        b._introItems.length - 1 == b._currentStep &&
          "function" === typeof b._introCompleteCallback &&
          b._introCompleteCallback.call(b);
        b._introItems.length - 1 != b._currentStep &&
          "function" === typeof b._introExitCallback &&
          b._introExitCallback.call(b);
        A.call(b, b._targetElement);
      };
      u.appendChild(q);
      1 < this._introItems.length && (u.appendChild(k), u.appendChild(m));
      n.appendChild(u);
      G.call(b, a.element, n, c, h);
    }
    !0 === this._options.disableInteraction && V.call(b);
    k.removeAttribute("tabIndex");
    m.removeAttribute("tabIndex");
    0 == this._currentStep && 1 < this._introItems.length
      ? ((m.className = "introjs-button introjs-nextbutton"),
        !0 == this._options.hidePrev
          ? ((k.className = "introjs-button introjs-prevbutton introjs-hidden"),
            (m.className += " introjs-fullbutton"))
          : (k.className =
      ...
      ? ((q.innerHTML = this._options.doneLabel),
        (k.className = "introjs-button introjs-prevbutton"),
        !0 == this._options.hideNext
          ? ((m.className = "introjs-button introjs-nextbutton introjs-hidden"),
            (k.className += " introjs-fullbutton"))
          : (m.className =
    ...
    "absolute" !== h &&
      "relative" !== h &&
      "fixed" !== h &&
      (a.element.className += " introjs-relativePosition");
    for (
      h = a.element.parentNode;
      null != h && h.tagName && "body" !== h.tagName.toLowerCase();
      ...
      u =
        v(h, "transform") ||
        v(h, "-webkit-transform") ||
        v(h, "-moz-transform") ||
        v(h, "-ms-transform") ||
        v(h, "-o-transform");
      if (/[0-9]+/.test(c) || 1 > n || ("none" !== u && void 0 !== u))
        h.className += " introjs-fixParent";
      h = h.parentNode;
    }
    W(a.element) ||
      !0 !== this._options.scrollToElement ||
      ((n = a.element.getBoundingClientRect()),
      (h = H().height),
      (c = n.bottom - (n.bottom - n.top)),
      (n = n.bottom - h),
      0 > c || a.element.clientHeight > h
        ? window.scrollBy(0, c - this._options.scrollPadding)
        : window.scrollBy(0, n + 70 + this._options.scrollPadding));
  ...
  function U(a) {
    ...
    b.onclick = function () {
      !0 == d._options.exitOnOverlayClick &&
        (void 0 != d._introExitCallback && d._introExitCallback.call(d),
        A.call(d, a));
    };
    setTimeout(function () {
    ...
    if (this._options.hints) {
      ...
      for (b = c.length; a < b; a++) {
        ...
        this._introItems.push({
          ...
          hintPosition:
            d.getAttribute("data-hintPosition") || this._options.hintPosition,
          hintAnimation: f,
          tooltipClass: d.getAttribute("data-tooltipClass"),
          position:
            d.getAttribute("data-position") || this._options.tooltipPosition,
        });
      }
    }
    X.call(this);
    document.addEventListener
      ? (document.addEventListener("click", w.bind(this), !1),
        window.addEventListener("resize", K.bind(this), !0))
      : document.attachEvent &&
        (document.attachEvent("onclick", w.bind(this)),
        document.attachEvent("onresize", K.bind(this)));
  }
  function K() {
    for (var a = 0, b = this._introItems.length; a < b; a++) {
      var c = this._introItems[a];
      "undefined" != typeof c.targetElement &&
        R.call(this, c.hintPosition, c.element, c.targetElement);
    }
  }
  function L(a) {
    w.call(this);
    var b = this._targetElement.querySelector(
      '.introjs-hint[data-step="' + a + '"]'
    );
    b && (b.className += " introjs-hidehint");
    "undefined" !== typeof this._hintCloseCallback &&
      this._hintCloseCallback.call(this, a);
  }
  function S(a) {
    if (
      (a = this._targetElement.querySelector(
        '.introjs-hint[data-step="' + a + '"]'
      ))
    )
      a.className = a.className.replace(/introjs\-hidehint/g, "");
  }
  function X() {
    var a = this,
      b = document.querySelector(".introjs-hints");
    null == b &&
      ((b = document.createElement("div")), (b.className = "introjs-hints"));
    for (var c = 0, d = this._introItems.length; c < d; c++) {
      ...
      if (!document.querySelector('.introjs-hint[data-step="' + c + '"]')) {
        ...
        f.element = e;
        R.call(this, f.hintPosition, e, f.targetElement);
        b.appendChild(e);
      }
    }
    document.body.appendChild(b);
    "undefined" !== typeof this._hintsAddedCallback &&
  ...
  function Y(a, b, c) {
    "undefined" !== typeof this._hintClickCallback &&
      this._hintClickCallback.call(this, a, b, c);
    var d = w.call(this);
    if (parseInt(d, 10) != c) {
  ...
  function P() {
    return (
      100 * (parseInt(this._currentStep + 1, 10) / this._introItems.length)
    );
  }
  var M = function (a) {
  ...
  M.fn = p.prototype = {
    ...
    hideHints: function () {
      ...
      if (a && 0 < a.length)
        for (var b = 0; b < a.length; b++)
          L.call(this, a[b].getAttribute("data-step"));
      return this;
    },
    showHint: function (a) {
      S.call(this, a);
    ...
    showHints: function () {
      ...
      if (a && 0 < a.length)
        for (var b = 0; b < a.length; b++)
          S.call(this, a[b].getAttribute("data-step"));
