(function (root, factory) {
  ...
  (function (window, document, Chartist) {
    ...
    Chartist.normalizeData = function (data, reverse, multi) {
      var labelCount;
      var output = { raw: data, normalized: {} };
    ...
    Chartist.createLabel = function (
      ...
      if (useForeignObject) {
        ...
        labelElement = group.foreignObject(
          content,
          Chartist.extend({ style: "overflow: visible;" }, positionalData)
        );
      } else {
        labelElement = group
    ...
    Chartist.splitIntoSegments = function (
      ...
      var defaultOptions = { increasingX: false, fillHoles: false };
      ...
      for (var i = 0; i < pathCoordinates.length; i += 2) {
        if (Chartist.getMultiValue(valueData[i / 2].value) === undefined) {
          ...
          if (hole) {
            segments.push({ pathCoordinates: [], valueData: [] });
            hole = false;
          }
  ...
  (function (window, document, Chartist) {
    ...
    Chartist.Interpolation.none = function (options) {
      var defaultOptions = { fillHoles: false };
      options = Chartist.extend({}, defaultOptions, options);
    ...
    Chartist.Interpolation.simple = function (options) {
      var defaultOptions = { divisor: 2, fillHoles: false };
      options = Chartist.extend({}, defaultOptions, options);
    ...
    Chartist.Interpolation.cardinal = function (options) {
      var defaultOptions = { tension: 1, fillHoles: false };
      options = Chartist.extend({}, defaultOptions, options);
    ...
    Chartist.Interpolation.step = function (options) {
      var defaultOptions = { postpone: true, fillHoles: false };
      options = Chartist.extend({}, defaultOptions, options);
  ...
  (function (window, document, Chartist) {
    ...
    Chartist.Class = { extend: extend, cloneDefinitions: cloneDefinitions };
  })(window, document, Chartist);
  (function (window, document, Chartist) {
    "use strict";
  ...
  (function (window, document, Chartist) {
      ...
      Object.keys(animations).forEach(
        function createAnimateForAttributes(attribute) {
          function createAnimate(animationDefinition, guided) {
            ...
            animate = this.elem(
              "animate",
              Chartist.extend({ attributeName: attribute }, animationDefinition)
            );
            if (guided) {
              setTimeout(
                function () {
    ...
    Chartist.Svg.List = Chartist.Class.extend({ constructor: SvgList });
  })(window, document, Chartist);
  (function (window, document, Chartist) {
    "use strict";
    ...
    function arc(rx, ry, xAr, lAf, sf, x, y, relative, data) {
      element(
        "A",
        { rx: +rx, ry: +ry, xAr: +xAr, lAf: +lAf, sf: +sf, x: +x, y: +y },
        this.pathElements,
        this.pos++,
        relative,
        data
      ...
      data.raw.series.forEach(
        function (series, index) {
          if (data.normalized.series[index] === 0 && options.ignoreEmptyValues)
            return;
          seriesGroups[index].attr({ "ct:series-name": series.name });
