!(function (e, t) {
  ...
  function g(e, t, n, r, i) {
    for (
      var o, a, s, u, l, c, f, d = e.length, g = p(t), y = [], b = 0;
      b < d;
      b++
    )
      if (((a = e[b]), a || 0 === a))
        if ("object" === pe.type(a)) pe.merge(y, a.nodeType ? [a] : a);
          ...
          if (
            (!fe.leadingWhitespace &&
              $e.test(a) &&
              y.push(t.createTextNode($e.exec(a)[0])),
            !fe.tbody)
          )
            for (
              a =
    ...
    for (
      u && g.removeChild(u),
        fe.appendChecked || pe.grep(h(y, "input"), v),
        b = 0;
      (a = y[b++]);
  ...
  function S(e, t, n, r) {
    ...
    var i,
      ...
      p = t[0],
      m = pe.isFunction(p);
    if (m || (f > 1 && "string" == typeof p && !fe.checkClone && rt.test(p)))
    ...
    if (
      f &&
      ((l = g(t, e[0].ownerDocument, !1, e, r)),
      (i = l.firstChild),
      1 === l.childNodes.length && (l = i),
      i || r)
    ) {
      for (s = pe.map(h(l, "script"), T), a = s.length; c < f; c++)
        (o = l),
          c !== d &&
            ((o = pe.clone(o, !0, !0)), a && pe.merge(s, h(o, "script"))),
          n.call(e[c], o, c);
      if (a)
        for (u = s[s.length - 1].ownerDocument, pe.map(s, k), c = 0; c < a; c++)
          (o = s[c]),
            Ie.test(o.type || "") &&
  ...
  function M(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += pe.css(e, n + Fe[o], !0, i)),
        r
          ? ("content" === n && (a -= pe.css(e, "padding" + Fe[o], !0, i)),
            "margin" !== n &&
              (a -= pe.css(e, "border" + Fe[o] + "Width", !0, i)))
          : ((a += pe.css(e, "padding" + Fe[o], !0, i)),
            "padding" !== n &&
              (a += pe.css(e, "border" + Fe[o] + "Width", !0, i)));
    return a;
  }
  ...
  var ye = (function (e) {
    function t(e, t, n, r) {
      ...
      if (
        !r &&
        ((t ? t.ownerDocument || t : P) !== H && L(t), (t = t || H), _)
      ) {
        if (11 !== m && (l = ge.exec(e)))
          if ((i = l[1])) {
            if (9 === m) {
            ...
            } else if (h && (a = h.getElementById(i)) && W(t, a) && a.id === i)
              return n.push(a), n;
          } else {
      ...
      var i = n.length > 0,
        ...
        a = function (r, a, s, u, l) {
          ...
          if (((p += h), i && h !== p)) {
            ...
            if (r) {
              if (p > 0) for (; h--; ) m[h] || g[h] || (g[h] = G.call(u));
              g = v(g);
            }
            K.apply(u, g),
    ...
    (w = t.support = {}),
        ...
        function (e) {
          ...
          return r !== H && 9 === r.nodeType && r.documentElement
            ? ((H = r),
              ...
              (w.getElementsByClassName = ve.test(H.getElementsByClassName)),
                    ...
                    return n
                      ...
                      : ((n =
                        ...
                        (!w.sortDetached && t.compareDocumentPosition(e) === n)
                          ? e === H || (e.ownerDocument === P && W(P, e))
                            ? -1
                            : t === H || (t.ownerDocument === P && W(P, t))
                            ? 1
                            : D
                            ? ee(D, e) - ee(D, t)
                            : 0
      ...
      (t.attr = function (e, t) {
        ...
        var n = C.attrHandle[t.toLowerCase()],
          r = n && Y.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !_) : void 0;
        return void 0 !== r
          ? r
          : w.attributes || !_
          ? e.getAttribute(t)
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !l.noBubble && !pe.isWindow(r)) {
          for (
            u = l.delegateType || p, Qe.test(u + p) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            d.push(s), (c = s);
  ...
  pe.extend({
    ...
    (pe.cssHooks.marginRight = L(fe.reliableMarginRight, function (e, t) {
      if (t) return dt(e, { display: "inline-block" }, mt, [e, "marginRight"]);
    })),
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : Ft.test(e.nodeName) || (Wt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
  ...
  pe.extend({
    ...
    ajax: function (t, n) {
          ...
          o
            ? (d.ifModified &&
              ...
              204 === t || "HEAD" === d.type
                ...
                : 304 === t
                ? (T = "notmodified")
                : ((T = b.state), (f = b.data), (y = b.error), (o = !y)))
            : ((y = T), (!t && T) || ((T = "error"), t < 0 && (t = 0))),
          (C.status = t),
          (C.statusText = (n || T) + ""),
          o ? m.resolveWith(p, [f, T, C]) : m.rejectWith(p, [C, T, y]),
          C.statusCode(g),
          (g = void 0),
          l && h.trigger(o ? "ajaxSuccess" : "ajaxError", [C, d, o ? f : y]),
          v.fireWith(p, [C, T]),
          l &&
      ...
      if ((c = U(Kt, d, n, C))) {
        if (((C.readyState = 1), l && h.trigger("ajaxSend", [C, d]), 2 === x))
          return C;
        d.async &&
          d.timeout > 0 &&
  ...
  (pe.fn.load = function (e, t, n) {
    ...
    pe.each(["top", "left"], function (e, t) {
      pe.cssHooks[t] = L(fe.pixelPosition, function (e, n) {
        if (n)
          return (n = mt(e, t)), ft.test(n) ? pe(e).position()[t] + "px" : n;
      });
    }),
  ...
  (function (e, t, n) {
    ...
    function i(e, t, n) {
      ...
      for (r in n)
        n.hasOwnProperty(r) &&
          ((i = r.replace(/ |$/g, t.eventNamespace)), e.bind(i, n[r]));
    }
    function o(e, t, n) {
      i(e, n, {
        focus: function () {
    ...
    function u(e, t, n) {
      setTimeout(function () {
        ...
        t.prop ? t.prop(r, i) : i ? t.attr(r, r) : t.removeAttr(r),
          s(e, n.checkedClass, i);
      }, 1);
    }
    function l(e, t, n) {
      s(e, n.disabledClass, t.is(":disabled"));
    }
    function c(e, t, n) {
      switch (n) {
        case "after":
    ...
    function f(e, n, i) {
      ...
      return (
        ...
        i.spanClass && a.addClass(i.spanClass),
        (s = r(e, "id")),
        n.useID && s && r(o, "id", n.idPrefix + "-" + s),
        i.spanHtml && a.html(i.spanHtml),
        (o = c(e, o, i.divWrap)),
        (a = c(e, a, i.spanWrap)),
        l(o, e, n),
        { div: o, span: a }
    ...
    function d(e, n) {
      ...
      return n.wrapperClass
        ? ((r = t("<span />").addClass(n.wrapperClass)), (r = c(e, r, "wrap")))
        : null;
    }
    function p() {
      var n, r, i, o;
    ...
    function g(e) {
      var t;
      return !!e[0].multiple || ((t = r(e, "size")), !(!t || t <= 1));
    }
    function y() {
      return !1;
    }
    function b(e, t) {
      var n = "none";
      i(e, t, { "selectstart dragstart mousedown": y }),
        e.css({
          MozUserSelect: n,
          msUserSelect: n,
          webkitUserSelect: n,
    ...
    function w(e, t, n) {
      ...
      for (
          ...
          e.each(function () {
            ...
            for (e in t)
              Object.prototype.hasOwnProperty.call(t, e) &&
                (r.push({ el: this, name: e, old: this.style[e] }),
                (this.style[e] = t[e]));
          }),
          n();
        r.length;
        ...
        (i = r.pop()), (i.el.style[i.name] = i.old);
    }
    function C(e, t) {
      var n;
      (n = e.parents()),
      ...
      N = [
          ...
          apply: function (t, n) {
            ...
            return (
              ...
              (d = t.is("a, button")
                ...
                : function () {
                    return h(r(t, "value")) || u;
                  }),
              (c = f(t, n, { divClass: n.buttonClass, spanHtml: d() })),
              (s = c.div),
              o(t, s, n),
              (p = !1),
              i(s, n, {
              ...
              {
                remove: function () {
                  return s.after(t), s.remove(), t.unbind(n.eventNamespace), t;
                },
                update: function () {
                  a(s, n), l(s, t, n), t.detach(), c.span.html(d()).append(t);
                },
              }
            );
          },
        },
        {
          ...
          apply: function (e, t) {
            var n, r, s;
            return (
              (n = f(e, t, { divClass: t.checkboxClass })),
              (r = n.div),
              (s = n.span),
              o(e, r, t),
              i(e, t, {
        ...
        },
        {
          ...
          apply: function (e, n) {
            ...
            var u,
              ...
              p,
              h,
              v = "undefined" != typeof e.is("multiple");
            return (
              (u = f(e, n, {
                divClass: n.fileClass,
                spanClass: n.fileButtonClass,
                spanHtml: v ? n.filesButtonHtml : n.fileButtonHtml,
                spanWrap: "after",
              })),
              (d = u.div),
              (h = u.span),
              ...
              m()
                ? i(e, n, {
                    click: function () {
                      e.trigger("change"), setTimeout(s, 0);
                    },
                  })
                : i(e, n, { change: s }),
              b(p, n),
              b(h, n),
              {
                remove: function () {
                  return (
                    p.remove(), h.remove(), e.unwrap().unbind(n.eventNamespace)
                  );
                },
                update: function () {
                  a(d, n), x(e, p, n), l(d, e, n);
                },
              }
            );
          },
          ...
          apply: function (e, n) {
            ...
            return (
              ...
              (r = f(e, n, {
                ...
                spanHtml: (
                  e.find(":selected:first") || e.find("option:first")
                ).html(),
                spanWrap: "before",
              })),
              (s = r.div),
              ...
              n.selectAutoWidth
                ? C(e, function () {
                    w(t([u[0], s[0]]), { display: "block" }, function () {
                      var e;
                ...
                : s.addClass("fixedWidth"),
              o(e, s, n),
              i(e, n, {
                change: function () {
                  u.html(e.find(":selected").html()),
                    s.removeClass(n.activeClass);
                },
                "click touchend": function () {
