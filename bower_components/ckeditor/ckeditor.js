  ...
  (window.CKEDITOR && window.CKEDITOR.dom) ||
          ...
          fire: (function () {
            ...
            return function (d, h, k) {
              ...
              if (g) {
                var v = g.listeners;
                if (v.length)
                  for (var v = v.slice(0), t, w = 0; w < v.length; w++) {
                    if (g.errorProof)
                      try {
      ...
      CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
        ...
        getDocumentPosition: function (a) {
          ...
          if (
            ...
            var m = this.$.getBoundingClientRect(),
              ...
              r = !0;
            CKEDITOR.env.ie &&
              ((r = g.getDocumentElement().contains(this)),
        ...
        scrollIntoParent: function (a, b, c) {
          ...
          function p(a, b) {
            ...
            c = a.getWindow();
            c.equals(b) ||
              ((c = p(CKEDITOR.dom.element.get(c.$.frameElement), b)),
              (g.x += c.x),
              (g.y += c.y));
            return g;
          }
          ...
          a instanceof CKEDITOR.dom.window &&
            (a = r ? f.getBody() : f.getDocumentElement());
          CKEDITOR.env.webkit &&
            (f = this.getEditor(!1)) &&
              ...
              ? c.type == CKEDITOR.NODE_ELEMENT &&
                (c =
                  0 < k
                    ...
                    : !1 === f(c, !0)
                    ? null
                    : c.getPreviousSourceNode(!0, n, f))
              : ((c = d),
                c.type == CKEDITOR.NODE_ELEMENT &&
                  ((c = c.getChild(e)) ||
                    (c =
                      !1 === f(d, !0) ? null : d.getNextSourceNode(!0, n, f)))),
            c && !1 === f(c) && (c = null));
        for (; c && !this._.end; ) {
          this.current = c;
          ...
          for (N = S; N <= T; N++)
            if (((c = E[N]), (ca = c.getPrevious()), c.equals(J[N])))
              ...
              N != T || (c.equals(J[N]) && T < O)
                ...
                : F
                ? k(c, M, !1, I)
                : K && M.append(a.document.createText(c.substring(0, B)));
          ...
          switch (a) {
            ...
            case CKEDITOR.ENLARGE_ELEMENT:
              ...
              B.type == CKEDITOR.NODE_TEXT
                ? (F &&
                    ...
                    (x = !!B)),
                  B && ((y = B.getPrevious()) || (u = B.getParent())))
                : (F && (y = B.getChild(F - 1) || B.getLast()), y || (u = B));
              for (u = c(u); u || y; ) {
                if (u && !y) {
                  !C && u.equals(f) && (C = !0);
                  if (e ? u.isBlockBoundary() : !h.contains(u)) break;
                  (x && "inline" == u.getComputedStyle("display")) ||
                    ((x = !1), C ? (m = u) : this.setStartBefore(u));
                  y = u.getPrevious();
                }
                for (; y; )
              ...
              for (; u || y; ) {
                if (u && !y) {
                  ...
                  if (e ? u.isBlockBoundary() : !h.contains(u)) break;
                  (x && "inline" == u.getComputedStyle("display")) ||
                    ((x = !1), C ? (l = u) : u && this.setEndAfter(u));
                  y = u.getNext();
                }
                for (; y; ) {
                  B = !1;
            ...
            case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
              ...
              this.setStartAt(
                H,
                !H.is("br") &&
                  ((!u && this.checkStartOfBlock()) || (u && H.contains(u)))
              ...
              this.setEndAt(
                H,
                (!u && this.checkEndOfBlock()) || (u && H.contains(u))
      ...
      a.prototype = {
        getNextParagraph: function (a) {
          ...
          if (!this._.started) {
            ...
            p.collapsed ||
              ((f = new CKEDITOR.dom.walker(p.clone())),
              (q = CKEDITOR.dom.walker.bookmark(!0, !0)),
              (f.evaluator = q),
              (this._.nextNode = f.next()),
              (f = new CKEDITOR.dom.walker(p.clone())),
              (f.evaluator = q),
              (f = f.previous()),
              (this._.lastNode = f.getNextSourceNode(!0, null, p.root)),
              this._.lastNode &&
          ...
          for (this._.nextNode = null; q; ) {
            ...
            if (A)
              ...
              if (
                ...
                q.isBlockBoundary(this.forceBrBreak && !z && { br: 1 })
              ) {
                if ("br" == y) A = 1;
                ...
                f &&
                  (f.setEndAt(q, CKEDITOR.POSITION_BEFORE_START),
                  "br" != y && (this._.nextNode = q));
                r = 1;
              } else {
                if (q.getFirst()) {
                  f ||
                    ((f = this.range.clone()),
                    f.setStartAt(q, CKEDITOR.POSITION_BEFORE_START));
                  q = q.getFirst();
                  continue;
                }
                A = 1;
          ...
          t &&
            ...
            ("br" == t.getName()
              ? t.remove()
              : t.getLast() &&
                "br" == t.getLast().$.nodeName.toLowerCase() &&
                t.getLast().remove());
          w &&
            (t = g.getLast()) &&
            t.type == CKEDITOR.NODE_ELEMENT &&
            "br" == t.getName() &&
            (!CKEDITOR.env.needsBrFiller || t.getPrevious(m) || t.getNext(m)) &&
            t.remove();
          this._.nextNode ||
            (this._.nextNode =
              l || g.equals(p) || !p ? null : this._getNextSourceNode(g, 1, p));
          return g;
        },
    ...
    (function () {
      function a(a, b, c, d, e) {
        ...
        for (g in b) {
          ...
          for (u in K) {
            ...
            for (E in q)
              "!" == E.charAt(0) &&
                ((E = E.slice(1)), C.push(E), (y[E] = !0), (n = !1));
      ...
      function t(a, b, d, e) {
        ...
        if (e.doCallbacks && a.elementCallbacks) {
          a: {
            ...
            for (var h = 0, u = k.length, m; h < u; ++h)
              if ((m = k[h](b))) {
                k = m;
                break a;
              }
      ...
      function u(a, b, c) {
        ...
        if (F.$empty[d] || !a.children.length)
          ...
          if ("br" == b)
            a.previous && !A(a.previous) && ((b = z()), b.insertBefore(a)),
            ...
            function (a) {
              if (a.type == CKEDITOR.NODE_ELEMENT) {
                ...
                a: {
                  ...
                  1 == d.children.length &&
                    (u = d.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                    t(e, u, c, m);
                  c = !c.length;
                }
                c || g.push(a);
              ...
              a.call(
                ...
                function (a) {
                  ...
                  for (d in a) {
                    ...
                    if (!f[d]) {
                      if (n.icons)
                        for (var t = n.icons.split(","), w = t.length; w--; )
        ...
        CKEDITOR.plugins.load(c.split(","), function (c) {
          ...
          for (var k in c) {
            ...
            u &&
              !a.lang[k] &&
              (u.split && (u = u.split(",")),
              0 <= CKEDITOR.tools.indexOf(u, a.langCode)
                ? (m = a.langCode)
                : ((m = a.langCode.replace(/-.*/, "")),
                  (m =
                    m != a.langCode && 0 <= CKEDITOR.tools.indexOf(u, m)
                      ? m
                      : 0 <= CKEDITOR.tools.indexOf(u, "en")
                      ? "en"
                      : u[0])),
    ...
    (function () {
      ...
      CKEDITOR.htmlParser.fragment.fromHtml = function (m, l, d) {
        ...
        function n(b, c, e) {
          ...
          var f = z;
          void 0 === b.previous &&
            (v(c, b) && ((z = c), w.onTagOpen(d, {}), (b.returnPoint = c = z)),
            g(b),
          ...
          if (a(e)) q.push(e);
            ...
            if ("br" == d) r.push(e);
              ...
              for (
                ...
                if (z.isOptionalClose) w.onTagClose(g);
        ...
        w.onText = function (a) {
          if (
            !((z._.hasInlineStarted && !r.length) || u || A) &&
          ...
          var b = z.name,
            g = b
              ? CKEDITOR.dtd[b] ||
                (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
              : c;
          if (!A && !g["#"] && b in f) w.onTagOpen(e[b] || ""), w.onText(a);
          else {
            k();
            h();
            u || A || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
      ...
      function g(a, b) {
        return a.replace(b, function (a, b, c) {
          0 === a.indexOf("\x3ctextarea") &&
            (a =
              b +
              t(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") +
              "\x3c/textarea\x3e");
          return (
            "\x3ccke:encoded\x3e" +
            encodeURIComponent(a) +
          ...
          elements: {
            ...
            table: function (a) {
              a.children.slice(0).sort(function (a, b) {
                ...
                a.type == CKEDITOR.NODE_ELEMENT &&
                  b.type == a.type &&
                  ((c = CKEDITOR.tools.indexOf(A, a.name)),
                  (d = CKEDITOR.tools.indexOf(A, b.name)));
                (-1 < c && -1 < d && c != d) ||
          ...
          insertElementIntoRange: function (a, b) {
            ...
            b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
              (b.startContainer.is({
                ...
                ? q(b)
                : b.startContainer.is(CKEDITOR.dtd.$list) && r(b));
            var f, k;
            if (g)
              for (
                ;
            ...
            if (!this.is("textarea")) {
                      ...
                      f[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                        ? (a.fire("saveSnapshot"),
                          f[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                            h.remove(),
                          f["moveToElementEdit" + (c ? "End" : "Start")](r),
                          f.select(),
                          a.fire("saveSnapshot"),
                          (d = 1))
                        : k.blockLimit &&
              ...
              CKEDITOR.env.gecko &&
                this.attachListener(this, "mouseup", function (b) {
                  if (
                    2 == b.data.$.button &&
                    ((b = b.data.getTarget()), !b.getOuterHtml().replace(w, ""))
                  ) {
                    var c = a.createRange();
              ...
              if (
                ...
                a: {
                  ...
                  if (
                    ...
                    A = 0;
                    for (w = N.count(); A < w; A++)
                      if (((E = N.getItem(A)), !E.is(q))) break a;
            ...
            if (this.isLocked) {
              ...
              a: {
                ...
                if (
                  ...
                  f.type == CKEDITOR.NODE_ELEMENT &&
                  ((k = k.clone()),
                  k.shrink(CKEDITOR.SHRINK_ELEMENT, !0),
                  (h = k.getEnclosedNode()) &&
              ...
              if (f) this.fake(f);
                ...
                if (n) {
                  ...
                  g
                    ? ((h = f.document.$.body.createTextRange()),
                      h.moveToElementText(g.$),
                    ...
                    : ((r = b.getNext(k)),
                      ...
                      (r =
                        !(r && r.getText && r.getText().match(h)) &&
                        (q ||
                          !b.hasPrevious() ||
                          (b.getPrevious().is && b.getPrevious().is("br")))),
                      (q = f.document.createElement("span")),
                      q.setHtml("\x26#65279;"),
                      q.insertBefore(b),
                      r && f.document.createText("﻿").insertBefore(b));
                  f.setStartBefore(b);
                  b.remove();
                  a
                    ? (r
                      ...
                      q.remove())
                    : (f.setEndBefore(g), g.remove(), p.select());
                } else {
                  g = this.getNative();
                  if (!g) return;
    ...
    (function () {
      ...
      function b(c) {
        ...
        if (c.collapsed)
          ...
          for (
            z.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (z = 0);
            z;

          ) {
            l = !1;
            if (z.equals(t)) (z = null), (l = !0);
            else {
                  ...
                  if (
                    (u ||
                      (A &&
                        ...
                        (z.getPosition(t) | K) != K) ||
                      ((u = c.clone()), u.setStartBefore(z)),
                    (A = z.type),
                    A == CKEDITOR.NODE_TEXT ||
                      v ||
                      (A == CKEDITOR.NODE_ELEMENT && !z.getChildCount()))
                  ) {
                    for (
                      var A = z, H;
                      (l = !A.getNext(I)) &&
                      ((H = A.getParent()), n[H.getName()]) &&
                      f(H, p, h, J);
              ...
              for (
                ...
                if (y.getName() == g) {
                  for (fa in h.attributes)
                    !D[fa] &&
                      (F = y.getAttribute(W)) &&
                      (l.getAttribute(fa) == F ? (x[fa] = 1) : (D[fa] = 1));
                  for (W in h.styles)
                    !B[W] &&
                      (F = y.getStyle(W)) &&
                      (l.getStyle(W) == F ? (A[W] = 1) : (B[W] = 1));
                }
                y = y.getParent();
              }
          ...
          for (
            ...
            if (this.checkElementRemovable(h)) {
              ...
              (a.checkBoundaryOfElement(h, CKEDITOR.END) ||
                ...
                ? ((g = h), (g.match = k ? "start" : "end"))
                : (h.mergeSiblings(),
                  h.is(this.element)
                    ? t.call(this, h)
                    : p(h, u(this)[h.getName()]));
            }
          if (g) {
            h = d;
            for (f = 0; ; f++) {
      ...
      CKEDITOR.style = function (a, b) {
        ...
        c &&
          ...
          delete c.style);
        b &&
          ((a = CKEDITOR.tools.clone(a)), A(a.attributes, b), A(a.styles, b));
              ...
              if (!(3 > arguments.length)) {
                ...
                CKEDITOR.ui.dialog.labeledElement.call(
                  ...
                  function () {
                    ...
                    for (
                      var m = 0, r;
                      m < c.items.length && (r = c.items[m]);
                      m++
                    )
                      f.push(
                        '\x3coption value\x3d"',
                        CKEDITOR.tools
                          .htmlEncode(void 0 !== r[1] ? r[1] : r[0])
                          .replace(/"/g, "\x26quot;"),
                        '" /\x3e ',
                        CKEDITOR.tools.htmlEncode(r[0])
                      );
                    "undefined" != typeof a.inputStyle &&
                      (a.style = a.inputStyle);
        ...
        CKEDITOR.dialog.addUIElement("fieldset", {
          build: function (a, b, c) {
            for (
              ...
              f.push(q);
              l.push(
                CKEDITOR.dialog._.uiElementBuilders[e.type].build(a, e, q)
              );
            }
    ...
    (function () {
      ...
      function g(a) {
        function b(c) {
          var r = "rtl" == f.lang.dir,
            ...
            q = m.height,
            p =
              n + (c.data.$.screenX - l.x) * (r ? -1 : 1) * (a._.moved ? 1 : 2),
      ...
      CKEDITOR.dialog = function (b, d) {
        ...
        CKEDITOR.event.call(this);
        this.definition = p = CKEDITOR.fire(
          "dialogDefinition",
          { name: d, definition: p },
          b
        ).definition;
        ...
        if (b._.removeDialogTabs && (t = b._.removeDialogTabs[d]))
          for (A = 0; A < t.length; A++) p.removeContents(t[A]);
          ...
          function () {
            ...
            b.config.dialog_startupFocusTab && a
              ...
              : this._.hasFocus ||
                ...
                p.onFocus ? (a = p.onFocus.call(this)) && a.focus() : l(1));
          },
          this,
          null,
          4294967295
        ...
        k(this);
        g(this);
        new CKEDITOR.dom.text(p.title, CKEDITOR.document).appendTo(
          this.parts.title
        );
        ...
        A = [];
        t = CKEDITOR.dialog._.uiElementBuilders.hbox
          .build(
            this,
            {
              type: "hbox",
      ...
      var q = {
        ...
        r = function (a, b, c) {
          for (var d = 0, e; (e = a[d]); d++)
            if (e.id == b || (c && e[c] && (e = r(e[c], b, c)))) return e;
          return null;
        },
        ...
        CKEDITOR.ui.dialog = {
          uiElement: function (a, b, c, d, e, f, g) {
            if (!(4 > arguments.length)) {
              ...
              b.align &&
                ((p = b.align),
                (l["margin-left"] = "left" == p ? 0 : "auto"),
                (l["margin-right"] = "right" == p ? 0 : "auto"));
              ...
              CKEDITOR.ui.dialog.uiElement.call(
                ...
                function () {
                  ...
                  for (k = 0; k < c.length; k++) {
                    ...
                    g
                      ? g[k] && d.push("width:" + w(g[k]))
                      : d.push("width:" + Math.floor(100 / c.length) + "%");
                    h && d.push("height:" + w(h));
                    e &&
                      void 0 !== e.padding &&
                      d.push("padding:" + w(e.padding));
                    CKEDITOR.env.ie &&
                      CKEDITOR.env.quirks &&
                      f[k].align &&
      ...
      function f(b) {
        ...
        function m(a, c) {
          ...
          if (!d.getById("cke_pastebin")) {
            ...
            var r = new CKEDITOR.dom.element(
            ...
            CKEDITOR.env.webkit
              ...
              : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(r);
            r.setStyles({
              position: "absolute",
            ...
            (n = r.getParent().isReadOnly())
              ? (r.setOpacity(0), r.setAttribute("contenteditable", !0))
              : r.setStyle(
        ...
        function y(c) {
          ...
          e && B.canClipboardApiBeTrusted(d.dataTransfer, b)
            ? (c.data.preventDefault(),
              setTimeout(function () {
                a(b, d);
              }, 0))
            ...
            a.on(
              ...
              function (b) {
                ...
                if (
                  ...
                  1 == d.getFilesCount() &&
                  w != d.id &&
                  ((d = d.getFile(0)), -1 != CKEDITOR.tools.indexOf(l, d.type))
                ) {
        ...
        proto: {
          ...
          showBlock: function (a, c, e, f, l, d) {
            ...
            var n = this.element,
              ...
              v = t ? t.getDocumentPosition(v) : { x: 0, y: 0 },
              p = "rtl" == this._.dir,
              q = w.x + (f || 0) - v.x,
              r = w.y + (l || 0) - v.y;
            !p || (1 != e && 4 != e)
              ? p || (2 != e && 3 != e) || (q += c.$.offsetWidth - 1)
              : (q += c.$.offsetWidth);
                ...
                var a = CKEDITOR.tools.bind(function () {
                  ...
                  CKEDITOR.env.ie &&
                    ...
                    "rtl" == b.getComputedStyle("direction") &&
                      (q = CKEDITOR.env.ie8Compat
                        ? q -
                          2 * n.getDocument().getDocumentElement().$.scrollLeft
                        : q - (a.$.scrollWidth - a.$.clientWidth)));
                  var a = n.getFirst(),
                    l;
            ...
            for (var f = 0; f < e.length; f++) {
              ...
              if (g)
                for (var n in g) {
                  ...
                  !v ||
                    (v.command && !this.editor.getCommand(v.command).state) ||
                    ((v.state = g[n]), this.add(v));
                }
            }
          },
          onClick: function (a) {
        ...
        proto: {
          ...
          show: function (b, c, d, e) {
            ...
            if (!n) {
              ...
              t["rtl" == g.lang.dir ? 37 : 39] = CKEDITOR.env.ie
                ? "mouseup"
                : "click";
      ...
      CKEDITOR.menuItem = CKEDITOR.tools.createClass({
        ...
        proto: {
          render: function (a, f, d) {
            ...
            this.command &&
              ((v = n.getCommand(this.command)),
              (v = n.getCommandKeystroke(v)) &&
                (t = CKEDITOR.tools.keystrokeToString(
            ...
            a = {
              ...
              ariaShortcut: t
                ? n.lang.common.keyboardShortcut + " " + t.aria
                : "",
              href:
                ...
                if (!k.equals(d) && k.getDirection())
                  ...
                  if (g)
                    for (
                      ...
                      k.hasClass(g[v] + n[0]) &&
                        (k.removeClass(g[v] + n[0]), k.addClass(g[v] + n[1]));
    ...
    (function () {
      function a(a) {
        function c(f) {
          for (
            var h = t.startContainer, m = t.endContainer;
          ...
          for (
            ...
            if (((w[m].indent += p), 0 < p)) {
              var v = w[m].parent;
              w[m].parent = new CKEDITOR.dom.element(
                v.getName(),
                v.getDocument()
              );
            }
          ...
          if (!e.isIndent) {
            ...
            if ((x = f.getParent()) && x.is("li"))
              for (
                var p = h.listNode.getChildren(), B = [], D, m = p.count() - 1;
                0 <= m;
                m--
              )
          ...
          if (B && B.length)
            for (m = 0; m < B.length; m++) {
              for (
                D = f = B[m];
                (D = D.getNext()) && D.is && D.getName() in l;

              )
                CKEDITOR.env.needsNbspFiller &&
                  !f.getFirst(b) &&
                  f.append(t.document.createText(" ")),
                  f.append(D);
              f.insertAfter(x);
            }
        ...
        for (
          ...
          for (
            var w = t.getCommonAncestor();
            w && (w.type != CKEDITOR.NODE_ELEMENT || !l[w.getName()]);
          ...
          w ||
            ((w = t.startPath().contains(l)) &&
              t.setEndAt(w, CKEDITOR.POSITION_BEFORE_END));
          if (!w) {
            var p = t.getEnclosedNode();
            p &&
              p.type == CKEDITOR.NODE_ELEMENT &&
              p.getName() in l &&
              (t.setStartAt(p, CKEDITOR.POSITION_AFTER_START),
              t.setEndAt(p, CKEDITOR.POSITION_BEFORE_END),
              (w = p));
          }
          w &&
            t.startContainer.type == CKEDITOR.NODE_ELEMENT &&
            t.startContainer.getName() in l &&
            ((p = new CKEDITOR.dom.walker(t)),
            (p.evaluator = f),
            (t.startContainer = p.next()));
          w &&
            t.endContainer.type == CKEDITOR.NODE_ELEMENT &&
            t.endContainer.getName() in l &&
            ((p = new CKEDITOR.dom.walker(t)),
            (p.evaluator = f),
            (t.endContainer = p.previous()));
          if (w) return c(w);
        }
        return 0;
      }
    ...
    (function () {
      ...
      function b(a, b, c, d) {
        for (var e, f; (e = a[d ? "getLast" : "getFirst"](t)); )
      ...
      function m(a, d, e) {
        ...
        m
          ...
          : t && (m = t.getPrevious(g)) && n(m) && m.remove();
        (m = f.getLast()) &&
        ...
        v &&
          (f = l(v)) &&
          (k.contains(v) ? (b(f, v.getParent(), v), f.remove()) : k.append(f));
      ...
      CKEDITOR.plugins.list = {
        listToArray: function (a, b, c, e, f) {
          ...
          for (var g = 0, h = a.getChildCount(); g < h; g++) {
            ...
            if ("li" == k.$.nodeName.toLowerCase()) {
              ...
              c.push(l);
              for (var m = 0, n = k.getChildCount(), t; m < n; m++)
                (t = k.getChild(m)),
                  t.type == CKEDITOR.NODE_ELEMENT && d[t.getName()]
        ...
        arrayToList: function (a, b, c, e, f) {
          ...
          for (
            ...
            if (H.indent == v) {
              (n && a[t].parent.getName() == n.getName()) ||
                ((n = a[t].parent.clone(!1, 1)),
              ...
              (H = a[t - 1].element.getDirection(1)),
                (t = CKEDITOR.plugins.list.arrayToList(
                  a,
                  null,
                  t,
                  e,
                ...
                !D.getChildCount() &&
                  CKEDITOR.env.needsNbspFiller &&
                  7 >= l.$.documentMode &&
                  D.append(l.createText(" ")),
                D.append(t.listNode),
                (t = t.nextIndex);
            else if (-1 == H.indent && !c && h) {
              d[h.getName()]
                ? ((D = H.element.clone(!1, !0)),
                  F != h.getDirection(1) && D.setAttribute("dir", F))
                : (D = new CKEDITOR.dom.documentFragment(l));
        ...
        exec: function (b) {
          ...
          for (
            ...
            x.type == CKEDITOR.NODE_ELEMENT &&
              "td" == x.getName() &&
              l.setStartAt(t.startNode, CKEDITOR.POSITION_AFTER_START);
            B.type == CKEDITOR.NODE_ELEMENT &&
              "td" == B.getName() &&
              l.setEndAt(t.endNode, CKEDITOR.POSITION_BEFORE_END);
            l = l.createIterator();
            for (
              l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF;
              (t = l.getNextParagraph());

            )
              if (!t.getCustomData("list_block")) {
                CKEDITOR.dom.element.setMarker(m, t, "list_block", 1);
                for (
                  var D = b.elementPath(t),
                    x = D.elements,
                    B = 0,
                    D = D.blockLimit,
                    F,
                ...
                B ||
                  ...
                  B.getCustomData("list_group_object_" + n)
                    ? B.getCustomData("list_group_object_" + n).contents.push(t)
                    : ((x = { root: B, contents: [t] }),
                      CKEDITOR.dom.element.setMarker(
                        m,
                        B,
          ...
          for (F = []; 0 < k.length; )
            if (((x = k.shift()), this.state == CKEDITOR.TRISTATE_OFF))
              if (d[x.root.getName()]) {
                ...
                for (
                  var G = n.root.getDocument(), I = void 0, H = void 0, t = 0;
                  t < D.length;
                  t++
                ) {
                ...
                if (h && h.collapsed) {
                  ...
                  if (t) {
                    ...
                    if (
                      ...
                      x.equals(v)
                        ? ((k = 1), (x = C.next()))
                        : h.checkBoundaryOfElement(t, CKEDITOR.END) && (k = 2),
                      k && x)
                    ) {
                      h = h.clone();
        ...
        enterBlock: function (a, d, m, v) {
          if ((m = m || f(a))) {
            ...
            if (w && p) {
              if (r && (r.is("li") || r.getParent().is("li"))) {
                ...
                if (A.is("li"))
                  v || u
                    ? (v && u && m.remove(),
                      r[u ? "insertAfter" : "insertBefore"](A))
                    : r.breakParent(A);
                else {
                  if (a)
                    if (
                      (q.block.is("li")
                        ? ((A = t.createElement(
                          ...
                          x && A.setAttribute("dir", w),
                          C && A.setAttribute("style", C),
                          p && A.setAttribute("class", p),
                          r.moveChildren(A))
                        : (A = q.block),
                      v || u)
                    )
                      A[v ? "insertBefore" : "insertAfter"](m);
                    else r.breakParent(m), A.insertAfter(m);
              ...
              if (r && r.getParent().is("blockquote")) {
                ...
                r.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1)) ||
                  r.getPrevious().remove();
                r.getNext().getFirst(CKEDITOR.dom.walker.invisible(1)) ||
                  r.getNext().remove();
            ...
            if ((w = m.splitBlock(z))) {
              ...
              r
                ? ((y = r.getParent()),
                  y.is("li") && (r.breakParent(y), r.move(r.getNext(), 1)))
                : d &&
                  (y = d.getParent()) &&
                  y.is("li") &&
                  (d.breakParent(y),
              ...
              if (q || a) {
                ...
                !CKEDITOR.env.ie ||
                  !q ||
                  (a && d.getChildCount()) ||
                  (m.moveToElementEditStart(a ? d : A), m.select());
              ...
              ? (!e && m && h.test(r)
                  ? (m = q.getDirection())
                    ? ((l = l.createElement("div")),
                      ...
                      l.insertAfter(q),
                      c.setStart(l, 0))
                    : (l.createElement("br").insertAfter(q),
                      CKEDITOR.env.gecko && l.createText("").insertAfter(q),
                      c.setStartAt(
                        q.getNext(),
                        CKEDITOR.env.ie
                          ? CKEDITOR.POSITION_BEFORE_START
                  ...
                  : ((a =
                      "pre" == r && CKEDITOR.env.ie && 8 > CKEDITOR.env.version
                        ? l.createText("\r")
                        : l.createElement("br")),
                    c.deleteContents(),
                    c.insertNode(a),
          ...
          for (var v, t = l.length; t--; )
            if (
              ...
              if (
                ...
                void 0 === w &&
                  ((w = a.config["filebrowser" + f(d) + "BrowseUrl"]),
                  void 0 === w && (w = a.config.filebrowserBrowseUrl));
                w &&
                  ((v.onClick = b), (v.filebrowser.url = w), (v.hidden = !1));
              } else if (
                "QuickUpload" == v.filebrowser.action &&
                v["for"] &&
                ((w = v.filebrowser.url),
                void 0 === w &&
                  ((w = a.config["filebrowser" + f(d) + "UploadUrl"]),
            ...
            return function (d) {
              if ((m = a.editable())) {
                ...
                k
                  ? (z + y <= q.top
                      ? g("top")
                      : z + y > r.height - q.bottom
                      ? g("pin")
                      : g("bottom"),
                    (d = r.width / 2),
                    (d = e.floatSpacePreferRight
                      ? "right"
                      : 0 < q.left && q.right < r.width && q.width > p.width
        ...
        render: function (a, e) {
          ...
          k
            ? (n = a.getCommandKeystroke(k)) &&
              (v = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard, n))
            : (h += "off");
          ...
          h = {
            ...
            ariaShortcut: v
              ? a.lang.common.keyboardShortcut + " " + v.aria
              : "",
            titleJs:
          ...
          if (b) {
            if ((c = b.getAttribute("target")))
              ...
              for (
                ...
                ("yes" != u[2] && "1" != u[2]) ||
                u[1] in { height: 1, width: 1, top: 1, left: 1 }
                  ? isFinite(u[2]) && (C.target[u[1]] = u[2])
                  : (C.target[u[1]] = !0);
                    ...
                    if ("wysiwyg" == a.mode && !a.readOnly && !u) {
                      ...
                      u = setTimeout(function () {
                        ...
                        w &&
                          ...
                          !m.line.mouseNear() &&
                          (m.element = U(m, !0)) &&
                          ((m.trigger = r(m) || z(m) || X(m)) &&
                          !p(m, m.trigger.upper || m.trigger.lower)
                            ? m.line.attach().place()
      ...
      var U = (function () {
        ...
        X = (function () {
          function b(e) {
            ...
            for (
              var f = Number.MAX_VALUE, l, p, r, t;
            ...
            a.addCommand("maximize", {
              ...
              exec: function () {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                  ...
                  for (var q = [p, w], z = 0; z < q.length; z++)
                    c(q[z], q[z].getCustomData("maximize_saved_styles")),
                      q[z].removeCustomData("maximize_saved_styles");
                  for (q = a.container; (q = q.getParent()); )
                    c(q, q.getCustomData("maximize_saved_styles")),
                ...
                "wysiwyg" == a.mode
                  ? g
                    ? (CKEDITOR.env.gecko && e(a),
                      ...
                      (r = a.getSelection().getStartElement()) &&
                        r.scrollIntoView(!0))
                    : k.$.scrollTo(n.x, n.y)
                  : (g && ((r.selectionStart = g[0]), (r.selectionEnd = g[1])),
                    (r.scrollLeft = n[0]),
                    (r.scrollTop = n[1]));
                g = n = null;
                t = this.state;
            ...
            h({
              ...
              exec: function (b) {
                ...
                for (
                  ...
                  for (var n = 0, p = f[l].length; n < p; n++)
        ...
        init: function (e) {
          ...
          e.on("uiSpace", function (c) {
            if (c.data.space == e.config.toolbarLocation) {
              ...
              for (
                var v = e.toolbox.toolbars, t = a(e), w = t.length, p = 0;
                p < w;
                p++
              ) {
                var q,
                          ...
                          if (!r) {
                            ...
                            k.push(
                              ...
                              '" class\x3d"cke_toolbar' +
                                (u ? ' cke_toolbar_last"' : '"'),
                              z ? ' aria-labelledby\x3d"' + q + '_label"' : "",
                            ...
                            var F = v.push(r) - 1;
                            0 < F &&
                              ((r.previous = v[F - 1]), (r.previous.next = r));
                          }
                          B
                            ? g ||
                              (k.push(
