!(function (t) {
  ...
  function p(t) {
    var e = [],
      ...
      o = t.scaleY;
    return (
      i(s) && 0 !== s && e.push("rotate(" + s + "deg)"),
      i(a) && 1 !== a && e.push("scaleX(" + a + ")"),
      i(o) && 1 !== o && e.push("scaleY(" + o + ")"),
  ...
  (v.prototype = {
    ...
    read: function (t) {
      ...
      i.rotatable && (s.rotate = a),
        i.scalable && ((s.scaleX = o), (s.scaleY = h)),
        this.clone();
    },
    clone: function () {
      var i,
    ...
    build: function () {
      ...
      this.isLoaded &&
        ...
        a.cropBoxMovable && s.addClass(M).data(it, lt),
    ...
    unbuild: function () {
      this.isBuilt &&
        (this.isCompleted || clearTimeout(this.completing),
        (this.isBuilt = !1),
        (this.isCompleted = !1),
        ...
        i &&
          (n
            ? ((a = p - c.width),
              ...
              u &&
                this.isLimited &&
                ((c.minLeft = wt(g.left, g.left + g.width - c.width)),
                (c.minTop = wt(g.top, g.top + g.height - c.height)),
                (c.maxLeft = g.left),
                (c.maxTop = g.top),
                2 === n &&
                  (c.width >= p &&
                    ((c.minLeft = wt(0, a)), (c.maxLeft = xt(0, a))),
                  c.height >= l &&
                    ((c.minTop = wt(0, o)), (c.maxTop = xt(0, o))))))
            : ((c.minLeft = -c.width),
              (c.minTop = -c.height),
              (c.maxLeft = p),
              (c.maxTop = l)));
    ...
    limitCropBox: function (t, i) {
      ...
      t &&
        ...
        i &&
          (g
            ? ((d.minLeft = xt(0, c.left)),
              (d.minTop = xt(0, c.top)),
              (d.maxLeft = wt(p, c.left + c.width) - d.width),
              (d.maxTop = wt(l, c.top + c.height) - d.height))
            : ((d.minLeft = 0),
              (d.minTop = 0),
              (d.maxLeft = p - d.width),
              (d.maxTop = l - d.height)));
    ...
    renderCropBox: function () {
      ...
      (a.width > a.maxWidth || a.width < a.minWidth) && (a.left = a.oldLeft),
        ...
        t.movable &&
          t.cropBoxMovable &&
          this.$face.data(it, a.width === e && a.height === s ? dt : lt),
        this.$cropBox.css({
          width: a.width,
          height: a.height,
          left: a.left,
      ...
      if (!this.isDisabled) {
        ...
        if (((s = s || t(n.target).data(it)), Q.test(s))) {
          ...
          i.preventDefault(),
            ...
            s === ct && ((this.cropping = !0), this.$dragBox.addClass(T));
        }
      }
    },
    cropMove: function (t) {
    ...
    change: function (t, i) {
      ...
      switch (
        ...
        this.isLimited &&
          ((m = p.minLeft),
          (v = p.minTop),
          (w = m + wt(n.width, r.width, r.left + r.width)),
          (x = v + wt(n.height, r.height, r.top + r.height))),
      ...
      !this.isDisabled &&
        ...
        i
          ? ((this.url = t),
            ...
            this.isBuilt &&
              this.$preview.find("img").add(this.$clone2).attr("src", t))
    ...
    setDragMode: function (t) {
      ...
      this.isLoaded &&
        ...
        (e = s.movable && t === dt),
        (t = i || e ? t : ut),
        this.$dragBox.data(it, t).toggleClass(W, i).toggleClass(M, e),
        s.cropBoxMovable ||
          this.$face.data(it, t).toggleClass(W, i).toggleClass(M, e));
    },
  }),
    (v.DEFAULTS = {
      viewMode: 0,
