$(document).ready(function () {
  ...
  function handleNavigationMenuIcon() {
    $("#menu-icons").change(function () {
      if ($(this).is(":checked")) {
        $(
          '.pcoded .pcoded-navbar .pcoded-item > li > a .pcoded-micon:not(".pcoded-search-item .pcoded-micon")'
        ).hide();
      } else {
        $(
          '.pcoded .pcoded-navbar .pcoded-item > li > a .pcoded-micon:not(".pcoded-search-item .pcoded-micon")'
  ...
  function handleLeftItemAlign() {
    $("#leftitem-align")
      ...
      .on("change", function (get_value) {
        get_value = $(this).val();
        if (get_value === "left") {
          $(".pcoded-navbar .pcoded-left-item").removeClass(
            "pcoded-right-align"
          );
  ...
  function handleRightItemAlign() {
    $("#rightitem-align")
      ...
      .on("change", function (get_value) {
        get_value = $(this).val();
        if (get_value === "left") {
          $(".pcoded-navbar .pcoded-right-item").removeClass(
            "pcoded-right-align"
          );
  ...
  function handleSearchItemAlign() {
    $("#searchitem-align")
      ...
      .on("change", function (get_value) {
        get_value = $(this).val();
        if (get_value === "left") {
          $(".pcoded-navbar .pcoded-search-item").removeClass(
            "pcoded-right-align"
          );
          $(".pcoded-navbar .pcoded-search-item").addClass("pcoded-left-align");
        } else {
          $(".pcoded-navbar .pcoded-search-item").addClass(
            "pcoded-right-align"
          );
          $(".pcoded-navbar .pcoded-search-item").removeClass(
            "pcoded-left-align"
